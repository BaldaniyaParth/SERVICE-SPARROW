...
const Watchmen = () => {
  const Watchmenn = [
    {
      image: "./assets/img/watchmen.jpg",
      title: "watchmen",
      watchmename: "varma kanu",
      cityname: "delhi",
    ...
    {
      image: "./assets/img/girlsecurity.jpg",
      title: "watchmen",
      watchmename: "yadav rekha ",
      cityname: "surat",
      phonenumber: "91+8976543012",
      experienceyear: "2 year  experience",
      href: "/booknow",
    },
    {
      image: "./assets/img/mensecurity gurd.jpg",
      title: "watchmen",
      watchmename: " patil raju",
      cityname: "chennai",
      phonenumber: "91+7845435673",
    ...
    <>
            ...
            <div className="lg:w-4/1 md:ml-[-90px] mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 ">
                ...
                <p className="leading-relaxed text-white  text-center mx-16 text-xl">
                  Our watchmen service offers vigilant security solutions
                  tailored to our clients' needs. Our website provides detailed
                  information including profiles of our trained watchmen,
                  customizable security plans, transparent pricing, convenient
                  booking options, and customer reviews. Additionally, we may
                  offer supplementary services such as patrol checks,
                  surveillance, or emergency response to ensure comprehensive
      ...
      <div className=" text-blue-900 mt-5">
        ...
        <div className=" flex justify-center text-left mb-8 font-medium text-2xl">
          <br />
          ✔ Our watchmen are highly trained professionals, dedicated to
          providing vigilant security.
          <br />✔ We come fully equipped with all necessary supplies and
          equipment for our duties.
          <br />
          ✔ Enjoy transparent pricing with no hidden fees.
          <br />✔ Our services are fully bonded and insured for your peace of
          mind.
          <br />
          ✔ Conveniently schedule and make payments online, ensuring a
          hassle-free experience.
          <br />✔ No contracts or hidden fees, just reliable and trustworthy
          security services.
        </div>
        <p className="leading-relaxed text-blue-900 font-medium mx-32 text-2xl">
          <div className="container mx-auto mb-8">
            To book your Watchmen at your doorstep you can visit our Service
            Sparrow centre, or you can also book your Watchmen service by
